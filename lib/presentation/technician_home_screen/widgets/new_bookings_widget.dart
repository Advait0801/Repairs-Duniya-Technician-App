...
class _NewBookingWidgetState extends State<NewBookingWidget> {
  ...
  void initState() {
    ...
    Duration bookingDuration = parseTime(widget.time);
    Duration adjustedDuration = bookingDuration + const Duration(minutes: 3);

    DateTime currentTime = DateTime.now();
    Duration remainingTime =
        adjustedDuration - currentTime.difference(currentTime);
  ...
  Future<void> sendingNotification() async {
    ...
    notificationFormat(customerTokenId, customerId, phoneNumber);
  }

  notificationFormat(
      String customerTokenId, String customerId, String phoneNumber) async {
...
//   @override
//   Widget build(BuildContext context) {
//     final String date = widget.time.toString();
//     return Container(
//       margin: EdgeInsets.symmetric(horizontal: 9.h),
//       padding: EdgeInsets.all(20.h),
//       decoration: AppDecoration.gradientOnErrorToBlueGray.copyWith(
